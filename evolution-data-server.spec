...
Source0  : https://download.gnome.org/sources/evolution-data-server/3.24/evolution-data-server-3.24.5.tar.xz
...
%prep
%setup -q -n evolution-data-server-3.24.5
...
export LANG=C
export SOURCE_DATE_EPOCH=1502113644
mkdir clr-build
pushd clr-build
export AR=gcc-ar
