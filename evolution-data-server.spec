...
Source0  : https://download.gnome.org/sources/evolution-data-server/3.30/evolution-data-server-3.30.1.tar.xz
...
Requires: evolution-data-server-bin = %{version}-%{release}
Requires: evolution-data-server-data = %{version}-%{release}
...
%prep
%setup -q -n evolution-data-server-3.30.1
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1537803902
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
...
/usr/lib64/libedata-cal-1.2.so.29
/usr/lib64/libedata-cal-1.2.so.29.0.0
