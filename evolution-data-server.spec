...
Source0  : https://download.gnome.org/sources/evolution-data-server/3.24/evolution-data-server-3.24.6.tar.xz
...
%prep
%setup -q -n evolution-data-server-3.24.6
...
export LANG=C
export SOURCE_DATE_EPOCH=1504782698
mkdir clr-build
pushd clr-build
export AR=gcc-ar
