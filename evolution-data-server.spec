...
%prep
%setup -q -n evolution-data-server-3.56.1
cd %{_builddir}/evolution-data-server-3.56.1
pushd ..
cp -a evolution-data-server-3.56.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744383011
mkdir -p clr-build
pushd clr-build
