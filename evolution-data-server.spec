...
Source0  : https://download.gnome.org/sources/evolution-data-server/3.52/evolution-data-server-3.52.0.tar.xz
...
%prep
%setup -q -n evolution-data-server-3.52.0
cd %{_builddir}/evolution-data-server-3.52.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710887025
mkdir -p clr-build
pushd clr-build
