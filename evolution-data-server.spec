...
Source0  : https://download.gnome.org/sources/evolution-data-server/3.42/evolution-data-server-3.42.3.tar.xz
...
%prep
%setup -q -n evolution-data-server-3.42.3
cd %{_builddir}/evolution-data-server-3.42.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641846469
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/evolution-data-server-3.42.3/COPYING %{buildroot}/usr/share/package-licenses/evolution-data-server/570d185ea721e7d6aee7426be1b10a800af98aa8
pushd clr-build
%make_install
popd
