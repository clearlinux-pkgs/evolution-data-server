...
Version  : 3.50.1
Release  : 118
URL      : https://download.gnome.org/sources/evolution-data-server/3.50/evolution-data-server-3.50.1.tar.xz
Source0  : https://download.gnome.org/sources/evolution-data-server/3.50/evolution-data-server-3.50.1.tar.xz
...
%prep
%setup -q -n evolution-data-server-3.50.1
cd %{_builddir}/evolution-data-server-3.50.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697836944
mkdir -p clr-build
pushd clr-build
