...
Source0  : https://download.gnome.org/sources/evolution-data-server/3.32/evolution-data-server-3.32.3.tar.xz
...
%prep
%setup -q -n evolution-data-server-3.32.3
...
export LANG=C
export SOURCE_DATE_EPOCH=1560877878
mkdir -p clr-build
pushd clr-build
