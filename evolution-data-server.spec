...
Version  : 3.26.5
Release  : 24
URL      : https://download.gnome.org/sources/evolution-data-server/3.26/evolution-data-server-3.26.5.tar.xz
Source0  : https://download.gnome.org/sources/evolution-data-server/3.26/evolution-data-server-3.26.5.tar.xz
...
%prep
%setup -q -n evolution-data-server-3.26.5
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1517846634
mkdir clr-build
pushd clr-build
export AR=gcc-ar
