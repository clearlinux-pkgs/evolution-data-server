...
Source0  : http://ftp.gnome.org/pub/gnome/sources/evolution-data-server/3.22/evolution-data-server-3.22.5.tar.xz
...
%prep
%setup -q -n evolution-data-server-3.22.5

%build
export LANG=C
export SOURCE_DATE_EPOCH=1487017538
...
/usr/lib64/libcamel-1.2.so.59
/usr/lib64/libcamel-1.2.so.59.0.0
/usr/lib64/libebackend-1.2.so.10
/usr/lib64/libebackend-1.2.so.10.0.0
/usr/lib64/libebook-1.2.so.16
/usr/lib64/libebook-1.2.so.16.3.1
