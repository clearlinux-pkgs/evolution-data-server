...
Version  : 3.46.2
Release  : 104
URL      : https://download.gnome.org/sources/evolution-data-server/3.46/evolution-data-server-3.46.2.tar.xz
Source0  : https://download.gnome.org/sources/evolution-data-server/3.46/evolution-data-server-3.46.2.tar.xz
...
%prep
%setup -q -n evolution-data-server-3.46.2
cd %{_builddir}/evolution-data-server-3.46.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670506407
mkdir -p clr-build
pushd clr-build
