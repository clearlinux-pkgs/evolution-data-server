...
Source0  : https://download.gnome.org/sources/evolution-data-server/3.36/evolution-data-server-3.36.1.tar.xz
...
%prep
%setup -q -n evolution-data-server-3.36.1
cd %{_builddir}/evolution-data-server-3.36.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585321257
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/evolution-data-server-3.36.1/COPYING %{buildroot}/usr/share/package-licenses/evolution-data-server/570d185ea721e7d6aee7426be1b10a800af98aa8
pushd clr-build
%make_install
popd
