...
Version  : 3.26.6
Release  : 25
URL      : https://download.gnome.org/sources/evolution-data-server/3.26/evolution-data-server-3.26.6.tar.xz
Source0  : https://download.gnome.org/sources/evolution-data-server/3.26/evolution-data-server-3.26.6.tar.xz
...
%prep
%setup -q -n evolution-data-server-3.26.6
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1520545434
mkdir clr-build
pushd clr-build
export AR=gcc-ar
