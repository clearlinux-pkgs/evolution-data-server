...
Source0  : https://download.gnome.org/sources/evolution-data-server/3.34/evolution-data-server-3.34.0.tar.xz
...
%prep
%setup -q -n evolution-data-server-3.34.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1568043229
mkdir -p clr-build
pushd clr-build
