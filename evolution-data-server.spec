...
Version  : 3.52.3
Release  : 126
URL      : https://download.gnome.org/sources/evolution-data-server/3.52/evolution-data-server-3.52.3.tar.xz
Source0  : https://download.gnome.org/sources/evolution-data-server/3.52/evolution-data-server-3.52.3.tar.xz
...
%prep
%setup -q -n evolution-data-server-3.52.3
cd %{_builddir}/evolution-data-server-3.52.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719585723
mkdir -p clr-build
pushd clr-build
