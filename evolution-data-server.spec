...
Version  : 3.28.4
Release  : 36
URL      : https://download.gnome.org/sources/evolution-data-server/3.28/evolution-data-server-3.28.4.tar.xz
Source0  : https://download.gnome.org/sources/evolution-data-server/3.28/evolution-data-server-3.28.4.tar.xz
...
Requires: evolution-data-server-license
...
Patch1: 0001-Update-UnicodeString-class-path.patch
...
%prep
%setup -q -n evolution-data-server-3.28.4
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1531753226
mkdir clr-build
pushd clr-build
export AR=gcc-ar
...
export SOURCE_DATE_EPOCH=1531753226
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/evolution-data-server
cp COPYING %{buildroot}/usr/share/doc/evolution-data-server/COPYING
pushd clr-build
%make_install
popd
...
/usr/lib64/libcamel-1.2.so.61
/usr/lib64/libcamel-1.2.so.61.0.0
...
/usr/lib64/libedataserver-1.2.so.23
/usr/lib64/libedataserver-1.2.so.23.0.0
/usr/lib64/libedataserverui-1.2.so.2
/usr/lib64/libedataserverui-1.2.so.2.0.0

%files license
%defattr(-,root,root,-)
/usr/share/doc/evolution-data-server/COPYING
