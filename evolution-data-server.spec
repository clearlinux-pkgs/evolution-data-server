...
Version  : 3.26.0
Release  : 17
URL      : https://download.gnome.org/sources/evolution-data-server/3.26/evolution-data-server-3.26.0.tar.xz
Source0  : https://download.gnome.org/sources/evolution-data-server/3.26/evolution-data-server-3.26.0.tar.xz
...
%prep
%setup -q -n evolution-data-server-3.26.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1505136780
mkdir clr-build
pushd clr-build
export AR=gcc-ar
