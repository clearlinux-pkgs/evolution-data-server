...
Source0  : https://download.gnome.org/sources/evolution-data-server/3.56/evolution-data-server-3.56.2.tar.xz
...
%prep
%setup -q -n evolution-data-server-3.56.2
cd %{_builddir}/evolution-data-server-3.56.2
pushd ..
cp -a evolution-data-server-3.56.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748358771
mkdir -p clr-build
pushd clr-build
