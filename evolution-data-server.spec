...
Version  : 3.24.2
Release  : 12
URL      : https://download.gnome.org/sources/evolution-data-server/3.24/evolution-data-server-3.24.2.tar.xz
Source0  : https://download.gnome.org/sources/evolution-data-server/3.24/evolution-data-server-3.24.2.tar.xz
...
%prep
%setup -q -n evolution-data-server-3.24.2
...
export LANG=C
export SOURCE_DATE_EPOCH=1494352159
mkdir clr-build
pushd clr-build
export AR=gcc-ar
