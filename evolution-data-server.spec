...
Source0  : https://download.gnome.org/sources/evolution-data-server/3.26/evolution-data-server-3.26.1.tar.xz
...
%prep
%setup -q -n evolution-data-server-3.26.1
...
export LANG=C
export SOURCE_DATE_EPOCH=1506953637
mkdir clr-build
pushd clr-build
export AR=gcc-ar
