...
Source0  : https://download.gnome.org/sources/evolution-data-server/3.26/evolution-data-server-3.26.3.tar.xz
...
%prep
%setup -q -n evolution-data-server-3.26.3
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1513023676
mkdir clr-build
pushd clr-build
export AR=gcc-ar
