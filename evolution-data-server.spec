...
Source0  : https://download.gnome.org/sources/evolution-data-server/3.28/evolution-data-server-3.28.0.tar.xz
...
%prep
%setup -q -n evolution-data-server-3.28.0
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1522782839
mkdir clr-build
pushd clr-build
export AR=gcc-ar
