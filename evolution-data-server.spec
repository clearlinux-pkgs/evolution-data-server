...
Source0  : https://download.gnome.org/sources/evolution-data-server/3.46/evolution-data-server-3.46.1.tar.xz
...
%prep
%setup -q -n evolution-data-server-3.46.1
cd %{_builddir}/evolution-data-server-3.46.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666360939
mkdir -p clr-build
pushd clr-build
