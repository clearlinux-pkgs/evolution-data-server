...
Version  : 3.26.2.1
Release  : 20
URL      : https://download.gnome.org/sources/evolution-data-server/3.26/evolution-data-server-3.26.2.1.tar.xz
Source0  : https://download.gnome.org/sources/evolution-data-server/3.26/evolution-data-server-3.26.2.1.tar.xz
...
%prep
%setup -q -n evolution-data-server-3.26.2.1
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1510084026
mkdir clr-build
pushd clr-build
export AR=gcc-ar
