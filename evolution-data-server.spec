...
Source0  : https://download.gnome.org/sources/evolution-data-server/3.34/evolution-data-server-3.34.1.tar.xz
...
%prep
%setup -q -n evolution-data-server-3.34.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1570460331
mkdir -p clr-build
pushd clr-build
