...
Source0  : https://download.gnome.org/sources/evolution-data-server/3.46/evolution-data-server-3.46.4.tar.xz
...
%prep
%setup -q -n evolution-data-server-3.46.4
cd %{_builddir}/evolution-data-server-3.46.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676050642
mkdir -p clr-build
pushd clr-build
