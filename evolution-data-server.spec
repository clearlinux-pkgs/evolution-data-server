...
Source0  : https://download.gnome.org/sources/evolution-data-server/3.50/evolution-data-server-3.50.2.tar.xz
...
%prep
%setup -q -n evolution-data-server-3.50.2
cd %{_builddir}/evolution-data-server-3.50.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1703273032
mkdir -p clr-build
pushd clr-build
