...
Version  : 3.38.3
Release  : 74
URL      : https://download.gnome.org/sources/evolution-data-server/3.38/evolution-data-server-3.38.3.tar.xz
Source0  : https://download.gnome.org/sources/evolution-data-server/3.38/evolution-data-server-3.38.3.tar.xz
...
%prep
%setup -q -n evolution-data-server-3.38.3
cd %{_builddir}/evolution-data-server-3.38.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610123966
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/evolution-data-server-3.38.3/COPYING %{buildroot}/usr/share/package-licenses/evolution-data-server/570d185ea721e7d6aee7426be1b10a800af98aa8
pushd clr-build
%make_install
popd
...
/usr/lib64/libedataserver-1.2.so.25
/usr/lib64/libedataserver-1.2.so.25.0.0
