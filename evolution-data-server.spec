...
Source0  : https://download.gnome.org/sources/evolution-data-server/3.32/evolution-data-server-3.32.4.tar.xz
...
%prep
%setup -q -n evolution-data-server-3.32.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1563197420
mkdir -p clr-build
pushd clr-build
