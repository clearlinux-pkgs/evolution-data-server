...
Version  : 3.50.3
Release  : 120
URL      : https://download.gnome.org/sources/evolution-data-server/3.50/evolution-data-server-3.50.3.tar.xz
Source0  : https://download.gnome.org/sources/evolution-data-server/3.50/evolution-data-server-3.50.3.tar.xz
...
%prep
%setup -q -n evolution-data-server-3.50.3
cd %{_builddir}/evolution-data-server-3.50.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704485002
mkdir -p clr-build
pushd clr-build
